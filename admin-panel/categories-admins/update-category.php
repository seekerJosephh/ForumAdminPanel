...
<?php 
  ...
  $singlecategories = $categories->fetch(PDO::FETCH_OBJ);
  ...
  <div class="col">
    ...
    <form method="POST" action="update-category.php?id=<?php echo $id;?>">
          ...
          <div class="form-outline mb-4 mt-4">
            <input type="text" value="<?php echo $singlecategories->name?>" name="name" id="form2Example1" class="form-control" placeholder="name" />
